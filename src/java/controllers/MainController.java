...
import controllers.CreateGroup.CreateNewGroupController;
...
public class MainController {
    ...
    public void contacts() throws IOException {
        if(getContactsController() == null){
            loadUI("contacts", "/views/mainPage/contacts/contacts.fxml");
    ...
    public void conversations() throws IOException {
        loadUI("conversations", "/views/mainPage/conversations/conversations.fxml");
        getConvoController().setTheme(currentTheme);
    }

    public void newsFeed() throws IOException {
        loadUI("newsfeed", "/views/mainPage/newsFeed/newsFeed.fxml");
    }
    ...
    public void createNewGroup() throws IOException{
        if(uiScene.containsKey("createNewGroup")){
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/views/mainPage/createGroup/createNewGroup.fxml"));
    ...
    public void editProfile() throws IOException {
        ...
        if(uiScene.containsKey("editProfile")){
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/views/mainPage/editProfile.fxml"));
            Parent root = loader.load();
    ...
    public void settings() throws IOException {
        if(uiScene.containsKey("settings")){
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/views/mainPage/settings.fxml"));
